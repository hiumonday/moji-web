...
export default function Footer({ className }) {
  ...
  return (
    <div className={`relative ${className}`}>
      <Container>
        <div
          className={`grid max-w-screen-xl grid-cols-1 gap-10 pt-10 mx-auto mt-5 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5 ${className}`}
        >
          <div className="lg:col-span-2">
            ...
            <div className="max-w-md mt-4 ml-4 text-gray-500 dark:text-gray-400">
              Moji Education cung cấp các dịch vụ giáo dục cao cấp như tranh
              biện, năng lực tư duy, và chứng chỉ tiếng Anh, với giá cả phải
              chăng và hình thức học đổi mới để tối đa hóa tiếp cận với giáo
              dục.
            </div>
          </div>
          ...
          <div className="">
            ...
            <div className="flex mt-5 space-x-5 text-gray-400 dark:text-gray-500">
              ...
              <a href="https://facebook.com/MojiSATPlatform">
              ...
              <a href="https://www.linkedin.com/company/moji-education/">
