                          ...
                          <div className="mb-2">
                            ...
                            <div className="flex items-stretch gap-2">
                              ...
                              <button
                                ...
                                className="whitespace-nowrap px-4 text-sm border border-transparent rounded text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-300"
                              >
